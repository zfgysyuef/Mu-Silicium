...
gMemoryDescriptor[] = {
  ...
  {"RSRV1",              0x86E00000, 0x02A00000, AddMem, MEM_RES, SYS_MEM_CAP, Reserv, WRITE_BACK_XN},
  ...
  // ▼▼▼ 修复：将 Info Blk 放在正确的 0xA7600000，CPU Vectors 顺延，不影响 MMU 页表 ▼▼▼
  {"Info Blk",           0xA7600000, 0x00001000, AddMem, SYS_MEM, SYS_MEM_CAP, RtData, WRITE_BACK_XN},
  {"CPU Vectors",        0xA7601000, 0x00001000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK},
  // ▲▲▲
